const { ModalBuilder, Collection, EmbedBuilder, AttachmentBuilder, SlashCommandBuilder, PermissionsBitField, TextInputBuilder, TextInputStyle, ActionRowBuilder } = require('discord.js');
...
module.exports = {
	...
	async execute(interaction) {
        if(!interaction.member.permissions.has(permflag.KickMembers || permflag.BanMembers)) return interaction.reply({
